  ...
  return (
    <dialog className="max-w-svw w-svw max-h-svh h-svh" {...props}>
      ...
      <section id="modal-body">
        ...
        <hr className="ml-4 mr-4 border-t-4 border-[#998675] my-4 rounded"/>
        <p className="ml-4 mr-4 mb-5">In today's fast-paced tech world, finding the right resource can feel like looking for a needle in a haystack. That's why we built Resourcery, a tool created by and for developers in the Chingu community.</p>
        <p className="ml-4 mr-4 mb-5">Here, you can search through hand-picked technical resources shared in the #resource-treasures channel on Discord. Whether you're diving into JavaScript, exploring DevOps, or learning more about AI, Resourcery helps you find exactly what you need to level up.</p>
        <h2 className="text-center font-semibold mt-10 mb-4">Features</h2>
        <ul>
          <li className="flex items-start gap-3 ml-4 mr-4 mb-2">
          ...
          <li className="flex items-start gap-3 ml-4 mr-4">
            <FaWandMagicSparkles className="mt-1 flex-shrink-0"/> 
            <div>
